...
function WorldWeaverChat({ universeId, universeName, onClose }) {
      ...
      <div ref={scrollRef} className="flex-grow overflow-y-auto px-6 space-y-3 mb-4 pr-5 scroll-smooth custom-scrollbar min-h-0">
        ...
        {isSending && (
          <div className="flex justify-start">
            <div className="bg-surface-container-highest text-on-surface-variant p-3 rounded-lg text-xs animate-pulse">Processing world intent...</div>
          </div>
        )}
      </div>
